...
from GUI.Frames.NewProjectFrames.NewProjectFrame import NewProjectFrame
from GUI.Frames.ProjectFrames.ProjectFrame import ProjectFrame
from Controllers.Mongo import MongoDB
from pymongo.database import Database
from pathlib import Path
import shutil

class SiteManagementFrame(ctk.CTkFrame):
